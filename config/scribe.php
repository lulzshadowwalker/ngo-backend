...
return [
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                // You can exclude routes like health checks or admin routes here
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'This API uses Laravel Sanctum for authentication. To obtain a token, you need to authenticate through the appropriate endpoints. Include the token in the Authorization header as `Bearer {token}` for authenticated requests.',
    ],
